...
# add x11 libs
apt-get -o Dir="$_BINARY_TARBALL_EXTRACTED_FOLDER" -o Dir::State="/var/lib/apt" -o Dir::Etc="/etc/apt" -o Dir::Cache="/var/cache/apt" -o Dir::State::status="/var/lib/dpkg/status" install libx11-6
